...
country = {
    ...
    GOLD_TO_CASH_RATE = 20, -- Amount of money generated per gold unit From 15 by Tup
    GOLD_TO_WORKER_PAY_RATE = 1, -- Multiplier for how much money gold pays to pops From 0.75 by Tup
...
economy = {
    ...
    FACTORY_PAYCHECKS_LEFTOVER_FACTOR = 0.8, -- % of how much we pay to the pops and capitalists, from the leftovers. From 0.6 by Tup
    MAX_FACTORY_MONEY_SAVE = 20000,    -- how much money is stored maximum in a factory. From 1000 by Tup
    ...
    RGO_SUPPLY_DEMAND_FACTOR_FIRE = 0.0001,        -- how fast pops are Fired when there is a low demand From 0.2 by Tup
    EMPLOYMENT_HIRE_LOWEST = 0.01,                -- we Hire pops no slower then x% of total required per day
    EMPLOYMENT_FIRE_LOWEST = 0.0001,                -- we Fire pops no slower then x% of total required per day From 0.1 by Tup
    ...
    FACTORY_PURCHASE_MIN_FACTOR = 1,            -- the lowest % of its daily needs a factory will purchase From 0.5 by Tup
...
pops = {
    ...
    PDEF_BASE_CON = 200.0,            -- so half'ed effect. From 20.0 by Tup
    ...
    INVENTION_IMPACT_ON_DEMAND = 0.005, -- how much each invention in a country increases demand for a product in percent From 0.014 by Tup
